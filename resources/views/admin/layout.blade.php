    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="{{ route('admin') }}" class="d-block">Администратор</a>
                </div>
            </div>
            <!-- Sidebar Menu -->
            <nav class="mt-2">
...
{{--                    </li>--}}
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">@yield('header', 'Admin Panel')</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2022 Bostan</strong>
    </footer>
</div>
<!-- ./wrapper -->
